...
export function universalInit(domEl){
  ...
  document.body.appendChild( stats.domElement );//加到子节点，
	stats.domElement.style.position = 'absolute';
	stats.domElement.style.left = '130px';
  ...
  composer.addPass(effectFXAA)
	return {renderer,scene,stats,controls,camera,composer,effectFXAA,outlinePass} ;
}
//动态调整显示尺寸
...
export function loadMO(modelName){  //传参为文件名，加载obj与mtl，
